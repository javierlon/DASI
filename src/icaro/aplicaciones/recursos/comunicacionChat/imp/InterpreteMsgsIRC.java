...
public class InterpreteMsgsIRC {
    ...
    private MensajeSimple mens; // Modi Javi 
    private MensajeSimple mens3; // Modi Javi
    private MensajeSimple mens4; // Modi Javi
    private MensajeSimple mens5; // Modi Javi
    private MensajeSimple mens6; // Modi Javi 
    ...
    protected InterfazUsoAgente itfUsoAgenteaReportar; // Modi Javi
    protected InterfazUsoAgente itfUsoAgenteaReportar3; // Modi Javi
    protected InterfazUsoAgente itfUsoAgenteaReportar4; // Modi Javi
    protected InterfazUsoAgente itfUsoAgenteaReportar5; // Modi Javi
    protected InterfazUsoAgente itfUsoAgenteaReportar6; // Modi Javi
    ...
    // de esta forma el agente recibe mensajes con entidades del modelo de información
        ...
        anotacionesBusquedaPrueba.add("Incidencia");
        ...
        if ( itfAgenteDialogo!=null){
            ...
            try {
                ...
                if (infoExtraida.size()==0){
                    ...
                    mens6 = new MensajeSimple((Object)infoAenviar,sender,"AgenteAplicacion6");// Modi Javi
                }
                    ...
                    //Object infoAenviar = infoExtraida.get(0);// Modi Javi
                    mens = new MensajeSimple((Object)infoAenviar,sender,"AgenteAplicacionX");// Modi Javi
                    mens3 = new MensajeSimple((Object)infoAenviar,sender,"AgenteAplicacion3");// Modi Javi
                    mens4 = new MensajeSimple((Object)infoAenviar,sender,"AgenteAplicacion4");// Modi Javi
                    mens5 = new MensajeSimple((Object)infoAenviar,sender,"AgenteAplicacion5");// Modi Javi
                    
                    
                
                } else{
                    mensajeAenviar = new MensajeSimple(infoExtraida,sender,identAgenteGestorDialogo);
                    mens = new MensajeSimple(infoExtraida,sender,"AgenteAplicacionX"); // Modi Javi
                    mens3 = new MensajeSimple(infoExtraida,sender,"AgenteAplicacion3"); // Modi Javi
                    mens4 = new MensajeSimple(infoExtraida,sender,"AgenteAplicacion4"); // Modi Javi
                    mens5 = new MensajeSimple(infoExtraida,sender,"AgenteAplicacion5"); // Modi Javi
//                    mensajeAenviar.setColeccionContenido(infoExtraida); // los elementos de la colección se meterán en el motor
                }
                try {// Modi Javi
                itfUsoAgenteaReportar =  (InterfazUsoAgente) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ.obtenerInterfaz(NombresPredefinidos.ITF_USO+"AgenteAplicacionX");// Modi Javi
                itfUsoAgenteaReportar3 =  (InterfazUsoAgente) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ.obtenerInterfaz(NombresPredefinidos.ITF_USO+"AgenteAplicacion3");// Modi Javi
                itfUsoAgenteaReportar4 =  (InterfazUsoAgente) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ.obtenerInterfaz(NombresPredefinidos.ITF_USO+"AgenteAplicacion4");// Modi Javi
                itfUsoAgenteaReportar5 =  (InterfazUsoAgente) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ.obtenerInterfaz(NombresPredefinidos.ITF_USO+"AgenteAplicacion5");// Modi Javi
                itfUsoAgenteaReportar6 =  (InterfazUsoAgente) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ.obtenerInterfaz(NombresPredefinidos.ITF_USO+"AgenteAplicacion6");// Modi Javi
                } catch (Exception e) {// Modi Javi
                    
                }// Modi Javi
                itfAgenteDialogo.aceptaMensaje(mensajeAenviar);
                itfUsoAgenteaReportar.aceptaMensaje(mens); // Modi Javi
                itfUsoAgenteaReportar3.aceptaMensaje(mens3); // Modi Javi
                itfUsoAgenteaReportar4.aceptaMensaje(mens4); // Modi Javi
                itfUsoAgenteaReportar5.aceptaMensaje(mens5); // Modi Javi
                itfUsoAgenteaReportar6.aceptaMensaje(mens6); // Modi Javi
...
//                 i++;
             ...
             if(anotType.equalsIgnoreCase("Despedida")){ 
...
/* Método donde se crea una notificación 'Despedida'. */
