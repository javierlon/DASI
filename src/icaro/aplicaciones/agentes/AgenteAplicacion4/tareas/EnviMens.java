 ...
 */
package icaro.aplicaciones.agentes.AgenteAplicacion4.tareas;
...
public void ejecutar(Object... params)  {  
   try{                   
      itfUsoAgenteaReportar =  (InterfazUsoAgente) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ.obtenerInterfaz(NombresPredefinidos.ITF_USO+agen);           
         Notificacion infoAenviar = new Notificacion("AgenteAplicacion4");
         infoAenviar.setTipoNotificacion("s");
         MensajeSimple mens = new MensajeSimple((Object)infoAenviar,"AgenteAplicacion4","AgenteAplicacionDialogoCitas1");
