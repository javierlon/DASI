...
public void ejecutar(Object... params)  {  
   try{                   
      itfUsoAgenteaReportar =  (InterfazUsoAgente) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ.obtenerInterfaz(NombresPredefinidos.ITF_USO+agen);           
         Notificacion infoAenviar = new Notificacion("AgenteAplicacionX");
         infoAenviar.setTipoNotificacion("c");
         MensajeSimple mens = new MensajeSimple((Object)infoAenviar,"AgenteAplicacionX","AgenteAplicacionDialogoCitas1");
