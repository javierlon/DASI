 ...
 */
package icaro.aplicaciones.agentes.AgenteAplicacion5.tareas;
...
public void ejecutar(Object... params)  {  
   try{                   
      itfUsoAgenteaReportar =  (InterfazUsoAgente) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ.obtenerInterfaz(NombresPredefinidos.ITF_USO+agen);           
         Notificacion infoAenviar = new Notificacion("AgenteAplicacion5");
         infoAenviar.setTipoNotificacion("d");
         MensajeSimple mens = new MensajeSimple((Object)infoAenviar,"AgenteAplicacion5","AgenteAplicacionDialogoCitas1");
